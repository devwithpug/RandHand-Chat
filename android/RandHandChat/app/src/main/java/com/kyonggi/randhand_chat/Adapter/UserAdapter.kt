...
class UserAdapter(var profileList: MutableList<ResponseUser>) : RecyclerView.Adapter<UserAdapter.CustomViewHolder>(){
    ...
    // 유저 차단하기
    private fun blockedFriend(supplementService: IRetrofitUser, blockedId: String, position: Int) {
    ...
    // 유저 삭제하기
    private fun deleteFriend(supplementService: IRetrofitUser, friendId: String, position: Int) {
